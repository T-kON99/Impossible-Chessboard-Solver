...
if __name__ == "__main__":
    ...
    print(a)
    print('Guard will randomly place a key on one of the board')
    key = a.encode()
    print('Prisoner 1 attempts to encode')
    print(a.get_encoding_steps())
    print(f'Prisoner 1 flips coin {key} at location {a.get_pos(key)}')
    print('Prisoner 2 comes in and see a new board')
    print(a)
    decoded_loc = a.decode()
    print('Prisoner 2 attempts to decode')
    print(a.get_decoding_steps())
    print(f'Prisoner 2 guessed the original key location at coin-th: {decoded_loc}, at location {a.get_pos(decoded_loc)}')
